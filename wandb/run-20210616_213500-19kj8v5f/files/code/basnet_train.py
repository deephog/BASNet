...
salobj_dataloader = get_loader(data_dir+tra_image_dir, data_dir+tra_label_dir, batchsize=config.batchsize, trainsize=config.trainsize, fake_back_rate=0.2, back_dir=back_dir, pure_back_rate=0.2)
salobj_dataloader_te = get_loader(data_dir+te_image_dir, data_dir+te_label_dir, batchsize=config.batchsize, trainsize=config.trainsize, fake_back_rate=0, back_dir=None)
